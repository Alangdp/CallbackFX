...
public class ExampleController {
    ...
    private void seedProjects(Example screen) {
        ...
        for (String type : PROJECT_TYPES) {
            ...
            projects.add(new ExampleProject(name, owner, active, version, updatedAt, description));
        }
    ...
    private void configureTable(Example screen) {
        screen.projectNameColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().name()));
        screen.projectStatusColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().status()));
        screen.projectUpdatedColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().updatedAt()));
    ...
    private void saveProject(Example screen) {
        ...
        ExampleProject newProject = new ExampleProject(name, owner, active, version, updatedAt, description);
